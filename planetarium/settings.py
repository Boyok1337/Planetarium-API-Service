...
SECRET_KEY = 'django-insecure-igtmo(0r%ir+ug27xx3bua6f+tq0**lwp%dzvj(qha41%8ipd7'
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.getenv("REDIS_URL", f"redis://:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}/0"),
    }
}
